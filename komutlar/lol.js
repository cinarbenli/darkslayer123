...
const rank = (stats.rank =='Challenger' ? 'Challenger' :stats.rank =='Grandmaster' ? 'Büyük usta' :stats.rank =='Master' ? 'Usta' :stats.rank =='Diamond 1' ? 'Elmas 2' : stats.rank =='Diamond 2' ? 'Elmas 2' : stats.rank == 'Diamond 3' ? 'Elmas 3' :stats.rank =='Diamond 4' ? 'Elmas 4' :stats.rank =='Platinum 1' ? 'Platin 1' :stats.rank =='Platinum 2' ? 'Platin 2' :stats.rank =='Platinum 3' ? 'Platin 3' :stats.rank =='Platinum 4' ? 'Platin 4' :stats.rank =='Gold 1' ? 'Altın 1' :stats.rank =='Gold 2' ? 'Altın 2' :stats.rank =='Gold 3' ? 'Altın 3' :stats.rank =='Gold 4' ? 'Altın 4' :stats.rank =='Silver 1' ? 'Gümüş 1' :stats.rank =='Silver 2' ? 'Gümüş 2' :stats.rank =='Silver 3' ? 'Gümüş 3' :stats.rank =='Silver 4' ? 'Gümüş 4' :stats.rank =='Bronze 1' ? 'Bronze 1' :stats.rank =='Bronze 2' ? 'Bronz 2' :stats.rank =='Bronze 3' ? 'Bronz 3' :stats.rank =='Bronze 4' ? 'Bronz 4' :stats.rank =='Iron 1' ? 'Demir 1' :stats.rank =='Iron 2' ? 'Demir 2' :stats.rank =='Iron 3' ? 'Demir 3' :stats.rank =='Iron 4' ? 'Demir 4' : stats.rank == 'Unranked' ? 'Ranksız' : 'Yok')
