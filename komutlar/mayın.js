...
if (message.channel.id !== '702888207938748462') return message.channel.send(`:no_entry: Bu komut burda engellenmiştir. <#702888207938748462!!load mayın> kanalında kullanın`)
