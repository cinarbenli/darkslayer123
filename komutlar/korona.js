...
exports.run = async (client, message, args) => {
  ...
  let ülk = body.countrydata[0].info.title
    ...
    .setColor('RANDOM')
    .setTitle('COVID-19')
    .setDescription(`**${ülk}** adlı ülkenin Korona istatistikleri`)
    .setThumbnail('https://images-ext-1.discordapp.net/external/B7kLPavrqM8Q4SQ03KuFwhmQzTADRESxo31Hz4LG7oc/https/media.giphy.com/media/J1RWP1OyfkwATrL9cd/giphy.gif?width=375&height=375')
